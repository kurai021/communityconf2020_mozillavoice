export function changeBackground(){
    const valuesSlide = document.querySelector(".values")
    const imgBg = document.querySelector(".imgBg")
    const existing = document.querySelector(".existing")

    setInterval(function(){
        if (valuesSlide.classList.contains("present") || imgBg.classList.contains("present") || existing.classList.contains("present")){
